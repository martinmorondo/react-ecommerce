...
\r
        ...
        md:flex\r
        lg:right-6\r
      `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-right text-xs`,"aria-hidden":`true`})}),qn=({onClick:e})=>(0,F.jsx)(`button`,{type:`button`,onClick:e,"aria-label":`Diapositiva anterior`,className:`\r
        ...
        md:flex\r
        lg:left-6\r
      `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-left text-xs`,"aria-hidden":`true`})}),Jn=()=>{let e={dots:!0,infinite:Wn.length>1,speed:650,slidesToShow:1,slidesToScroll:1,autoplay:Wn.length>1,autoplaySpeed:6500,pauseOnHover:!0,pauseOnFocus:!0,arrows:Wn.length>1,swipeToSlide:!0,adaptiveHeight:!1,nextArrow:(0,F.jsx)(Kn,{}),prevArrow:(0,F.jsx)(qn,{}),appendDots:e=>(0,F.jsx)(`div`,{className:`\r
          absolute\r
      ...
      `,children:[(0,F.jsx)(`div`,{className:`\r
          ...
          sm:rounded-[2rem]\r
        `,"aria-hidden":`true`}),(0,F.jsx)(Gn,{...e,children:Wn.map((e,t)=>(0,F.jsxs)(`article`,{className:`\r
              relative\r
              outline-none\r
...
\r
                    ...
                    `,children:[(0,F.jsxs)(`span`,{className:`flex items-center gap-1.5`,children:[(0,F.jsx)(`span`,{className:`\r
                      ...
                      `,"aria-hidden":`true`}),(0,F.jsxs)(`span`,{className:`flex items-center gap-1.5`,children:[(0,F.jsx)(`span`,{className:`\r
                          ...
                          rounded-md\r
                          bg-white/[0.06]\r
                        `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-truck-fast text-[9px] text-primary/90`})}),`Envíos rápidos`]})]})]})})})]},e.id))})]})},Yn=()=>(0,F.jsxs)(`section`,{"aria-labelledby":`featured-offers-title`,className:`w-full pb-8 sm:pb-10 lg:pb-12`,children:[(0,F.jsx)(`h1`,{id:`featured-offers-title`,className:`sr-only`,children:`Ofertas destacadas`}),(0,F.jsx)(`div`,{className:`mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8`,children:(0,F.jsx)(Jn,{})})]}),Xn=Un.default.default??Un.default,Zn=e=>e.toLocaleString(`es-AR`,{minimumFractionDigits:0,maximumFractionDigits:0}),Qn=(e,t)=>t<=0||t>=100?e:e/(1-t/100),$n=({onClick:e})=>(0,F.jsx)(`button`,{type:`button`,onClick:e,"aria-label":`Siguiente oferta`,className:`\r
...
\r
        sm:h-11 sm:w-11\r
      `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-right text-[10px]`,"aria-hidden":`true`})}),er=({onClick:e})=>(0,F.jsx)(`button`,{type:`button`,onClick:e,"aria-label":`Oferta anterior`,className:`\r
...
\r
        sm:h-11 sm:w-11\r
      `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-left text-[10px]`,"aria-hidden":`true`})}),tr=({productItem:e})=>{let t=I(e=>e.addToCart),n=I(e=>e.toggleWishlist),r=I(t=>t.wishlist.some(t=>t.id===e.id)),[i,a]=(0,y.useState)(!1),o=(0,y.useRef)(null);(0,y.useEffect)(()=>()=>{o.current!==null&&window.clearTimeout(o.current)},[]);let s=Math.max(0,Math.min(99,e.discount??0)),c=Qn(e.price,s);return(0,F.jsx)(`div`,{className:`px-2 py-3`,children:(0,F.jsxs)(`article`,{className:`\r
          group relative\r
          flex h-full\r
          min-h-[415px]\r
          flex-col\r
...
\r
            ...
            `,children:(0,F.jsxs)(`div`,{className:`flex items-end justify-between gap-3`,children:[(0,F.jsxs)(`div`,{className:`min-w-0`,children:[s>0&&(0,F.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,F.jsxs)(`span`,{className:`\r
                        ...
                        text-gray-400\r
                        line-through\r
                      `,children:[`$`,Zn(c)]}),(0,F.jsx)(`span`,{className:`\r
                        rounded-full\r
                        bg-green-50\r
                        px-1.5 py-0.5\r
                        text-[8px]\r
                    ...
                    `,children:`Precio`}),(0,F.jsxs)(`span`,{className:`\r
                      ...
                      tracking-tight\r
                      text-secondary\r
                    `,children:[`$`,Zn(e.price)]})]})]}),(0,F.jsx)(`button`,{type:`button`,onClick:()=>{t(e),a(!0),o.current!==null&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>{a(!1),o.current=null},1200)},"aria-label":i?`${e.name} agregado al carrito`:`Agregar ${e.name} al carrito`,className:`
                  group/cart
                  flex h-11 w-11
                  shrink-0
                  items-center justify-center
...
\r
            ...
            bg-white/55\r
            py-1\r
          `,children:(0,F.jsx)(nr,{productItems:e})})]})]}),ir=Un.default.default??Un.default,ar=({onClick:e})=>(0,F.jsx)(`button`,{type:`button`,onClick:e,"aria-label":`Siguiente producto destacado`,className:`\r
      ...
      focus-visible:ring-offset-2\r
      sm:h-11 sm:w-11\r
    `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-right text-xs`,"aria-hidden":`true`})}),or=({onClick:e})=>(0,F.jsx)(`button`,{type:`button`,onClick:e,"aria-label":`Producto destacado anterior`,className:`\r
      ...
      focus-visible:ring-offset-2\r
      sm:h-11 sm:w-11\r
    `,children:(0,F.jsx)(`i`,{className:`fa-solid fa-chevron-left text-xs`,"aria-hidden":`true`})}),sr=({item:e})=>(0,F.jsxs)(`article`,{className:`\r
...
\r
          ...
          `,"aria-hidden":`true`})]}),(0,F.jsxs)(`div`,{className:`mt-auto p-4`,children:[(0,F.jsxs)(`div`,{className:`mb-4`,children:[(0,F.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-[0.14em] text-primary`,children:`Producto destacado`}),(0,F.jsx)(`h3`,{className:`mt-1 text-sm font-semibold text-secondary`,children:e.para})]}),(0,F.jsxs)(`div`,{className:`\r
            ...
            border-t border-black/[0.06]\r
            pt-4\r
          `,children:[(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-[10px] uppercase tracking-wider text-gray-400`,children:`Precio`}),(0,F.jsxs)(`span`,{className:`mt-0.5 block text-lg font-extrabold text-secondary`,children:[`$`,e.price.toLocaleString(`es-AR`)]})]}),(0,F.jsxs)(`span`,{className:`\r
              ...
              text-primary\r
            `,children:[(0,F.jsx)(`i`,{className:`fa-solid fa-arrow-trend-up text-[10px]`,"aria-hidden":`true`}),`Destacado`]})]})]})]}),cr=({topItems:e})=>{if(!e.length)return(0,F.jsx)(`div`,{className:`\r
          flex min-h-[250px]\r
          items-center justify-center\r
          rounded-2xl\r
          border border-dashed border-black/10\r
        ...
        `,role:`status`,children:(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`div`,{className:`\r
              ...
              bg-primary/10\r
              text-primary\r
            `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-star text-xl`})}),(0,F.jsx)(`h3`,{className:`font-bold text-secondary`,children:`No hay productos destacados`}),(0,F.jsx)(`p`,{className:`mt-1 text-sm text-gray-500`,children:`Volvé a intentarlo más tarde.`})]})});let t={dots:!1,infinite:e.length>3,speed:500,slidesToShow:3,slidesToScroll:1,autoplay:e.length>3,autoplaySpeed:5e3,pauseOnHover:!0,pauseOnFocus:!0,swipeToSlide:!0,arrows:e.length>1,nextArrow:(0,F.jsx)(ar,{}),prevArrow:(0,F.jsx)(or,{}),responsive:[{breakpoint:1024,settings:{slidesToShow:2}},{breakpoint:640,settings:{slidesToShow:1,arrows:!1}}]};return(0,F.jsx)(`div`,{className:`relative px-2 sm:px-4`,children:(0,F.jsx)(ir,{...t,children:e.map(e=>(0,F.jsx)(sr,{item:e},e.id))})})},lr=({topItems:e})=>(0,F.jsxs)(`section`,{"aria-labelledby":`top-categories-title`,className:`\r
        relative\r
        w-full\r
        overflow-hidden\r
        bg-white\r
...
\r
                        sm:text-lg\r
                      `,children:[`$`,ur(e.price)]})]}),(0,F.jsx)(`button`,{type:`button`,onClick:()=>a(e),"aria-label":t?`${e.name} agregado al carrito`:`Agregar ${e.name} al carrito`,className:`
                      group/cart
                      flex h-10 w-10
                      shrink-0
                      items-center justify-center
        ...
        `,role:`status`,children:(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`div`,{className:`\r
            ...
            `,children:[(0,F.jsx)(`span`,{className:`hidden sm:inline`,children:`Ver todos`}),(0,F.jsx)(`span`,{className:`sm:hidden`,children:`Ver más`}),(0,F.jsx)(`i`,{className:`\r
              ...
              `,"aria-hidden":`true`})]})]}),(0,F.jsx)(dr,{arrivalsItems:e})]})}),pr=[{value:`all`,label:`Todos los productos`,icon:`fa-border-all`},...L],mr=({selectedCategory:e,setSelectedCategory:t})=>(0,F.jsxs)(`aside`,{className:`\r
        w-full\r
        rounded-2xl\r
        border border-black/[0.06]\r
        bg-white\r
      ...
      `,"aria-label":`Filtrar productos por categoría`,children:[(0,F.jsxs)(`div`,{className:`mb-4 flex items-center justify-between`,children:[(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-[0.18em] text-primary`,children:`Explorar`}),(0,F.jsx)(`h2`,{className:`mt-1 text-lg font-extrabold tracking-tight text-secondary`,children:`Categorías`})]}),(0,F.jsx)(`span`,{className:`\r
            ...
            bg-primary/10\r
            text-primary\r
          `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-sliders text-sm`})})]}),(0,F.jsx)(`div`,{className:`space-y-1.5`,role:`group`,"aria-label":`Categorías disponibles`,children:pr.map(n=>{let r=n.value===`all`,i=r?e===null:e===n.value;return(0,F.jsxs)(`button`,{type:`button`,onClick:()=>t(r?null:n.value),"aria-pressed":i,className:`
                group
                flex w-full
                items-center gap-3
                rounded-xl
...
\r
          ...
          `,children:(0,F.jsxs)(`div`,{className:`flex items-end justify-between gap-3`,children:[(0,F.jsxs)(`div`,{className:`min-w-0`,children:[s>0&&(0,F.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,F.jsxs)(`span`,{className:`\r
                      ...
                      text-gray-400\r
                      line-through\r
                    `,children:[`$`,hr(c)]}),(0,F.jsx)(`span`,{className:`\r
                      rounded-full\r
                      bg-green-50\r
                      px-1.5 py-0.5\r
                      text-[8px]\r
                  ...
                  tracking-tight\r
                  text-secondary\r
                `,children:[`$`,hr(e.price)]})]}),(0,F.jsx)(`button`,{type:`button`,onClick:()=>{t(e),a(!0),o.current!==null&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>{a(!1),o.current=null},1200)},"aria-label":i?`${e.name} agregado al carrito`:`Agregar ${e.name} al carrito`,className:`
                group/cart
                flex h-11 w-11
                shrink-0
                items-center justify-center
                ...
                ${i?`
                    ...
                    `:`
                      ...
                      hover:shadow-[0_10px_24px_rgba(233,69,96,0.22)]
                    `}
              `,children:(0,F.jsx)(`i`,{className:`fa-solid ${i?`fa-check`:`fa-cart-plus`} text-sm transition-transform duration-300 ${i?`scale-110`:`group-hover/cart:scale-105`}`,"aria-hidden":`true`})})]})})]}),(0,F.jsx)(`span`,{className:`sr-only`,"aria-live":`polite`,children:i?`${e.name} agregado al carrito.`:``})]})},vr=({shopItems:e})=>(0,F.jsx)(`div`,{className:`\r
        grid\r
        grid-cols-2\r
        gap-3\r
        sm:gap-5\r
        lg:grid-cols-3\r
        xl:grid-cols-3\r
      `,children:e.map(e=>(0,F.jsx)(_r,{shopItem:e},e.id))}),yr=e=>e.normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).toLowerCase().trim(),br=e=>!e||e===`all`?null:L.some(t=>t.value===e)?e:null,xr=({shopItems:e})=>{let[t,n]=Nt(),r=t.get(`search`)??``,i=br(t.get(`category`)),[a,o]=(0,y.useState)(`default`),s=e=>{let r=new URLSearchParams(t);e?r.set(`category`,e):r.delete(`category`),n(r)},c=(0,y.useMemo)(()=>{let t=yr(r),n=[...e];if(t){let e=t.split(/\s+/).filter(Boolean);n=n.filter(t=>{let n=yr(t.name);return e.every(e=>n.includes(e))})}switch(i&&(n=n.filter(e=>e.category===i)),a){case`price-asc`:n.sort((e,t)=>e.price-t.price);break;case`price-desc`:n.sort((e,t)=>t.price-e.price);break;case`name`:n.sort((e,t)=>yr(e.name).localeCompare(yr(t.name),`es`))}return n},[e,r,i,a]),l=()=>{let e=new URLSearchParams(t);e.delete(`search`),n(e)},u=()=>{n({})},d=!!r||!!i,f=[!!r,!!i].filter(Boolean).length;return(0,F.jsxs)(`section`,{"aria-labelledby":`shop-title`,className:`\r
        relative\r
        w-full\r
        overflow-hidden\r
        bg-background\r
      ...
      `,children:[(0,F.jsx)(`div`,{className:`\r
        ...
        `,"aria-hidden":`true`}),(0,F.jsx)(`div`,{className:`relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8`,children:(0,F.jsxs)(`div`,{className:`\r
          ...
          `,children:[(0,F.jsx)(`div`,{className:`w-full lg:w-[250px] lg:shrink-0`,children:(0,F.jsx)(mr,{selectedCategory:i,setSelectedCategory:s})}),(0,F.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,F.jsxs)(`header`,{className:`\r
                mb-6\r
                rounded-[1.5rem]\r
                border border-black/[0.045]\r
                bg-white\r
                ...
                `,children:[(0,F.jsxs)(`div`,{className:`min-w-0`,children:[(0,F.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,F.jsx)(`p`,{className:`text-[10px] font-extrabold uppercase tracking-[0.18em] text-primary`,children:`Nuestra colección`}),(0,F.jsx)(`span`,{className:`\r
                  ...
                  `,children:[(0,F.jsxs)(`div`,{className:`\r
                    ...
                    `,children:[`Limpiar`,(0,F.jsx)(`i`,{className:`fa-solid fa-rotate-left text-[8px]`,"aria-hidden":`true`})]}),(0,F.jsxs)(`span`,{className:`\r
                      ...
                      text-gray-400\r
                      sm:inline-flex\r
                    `,children:[f,` `,f===1?`filtro`:`filtros`]})]})]}),c.length>0?(0,F.jsx)(vr,{shopItems:c}):(0,F.jsxs)(`div`,{className:`\r
                  flex min-h-[390px]\r
                  flex-col\r
                  items-center\r
                  justify-center\r
...
\r
                    ...
                    focus-visible:ring-primary/40\r
                    focus-visible:ring-offset-2\r
                  `,children:[`Ver todos los productos`,(0,F.jsx)(`i`,{className:`fa-solid fa-arrow-right text-[10px]`,"aria-hidden":`true`})]})]})]})]})})]})},Sr=({image:e,alt:t,eyebrow:n,title:r,description:i,href:a,size:o})=>{let s=o===`small`;return(0,F.jsxs)(`article`,{className:`
        group relative
      ...
      `,children:(0,F.jsxs)(`div`,{className:`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8`,children:[(0,F.jsxs)(`header`,{className:`mx-auto mb-8 max-w-2xl text-center sm:mb-10`,children:[(0,F.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-[0.18em] text-primary`,children:`Comprá con tranquilidad`}),(0,F.jsx)(`h2`,{id:`benefits-title`,className:`\r
              ...
              text-secondary\r
              sm:text-2xl\r
            `,children:`Todo pensado para vos`}),(0,F.jsx)(`p`,{className:`mt-2 text-sm leading-6 text-gray-500`,children:`Una experiencia de compra simple, segura y acompañada en cada paso.`})]}),(0,F.jsx)(`div`,{className:`grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4`,children:wr.map((e,t)=>(0,F.jsxs)(`article`,{className:`\r
                group relative\r
                overflow-hidden\r
                rounded-2xl\r
                border border-black/[0.06]\r
...
\r
  ...
  `,"aria-hidden":`true`,children:[(0,F.jsx)(`div`,{className:`\r
    ...
    `})]}),(0,F.jsx)(`div`,{className:`\r
              ...
              via-primary/50\r
              to-transparent\r
            `,"aria-hidden":`true`})]})})}),Lr=()=>{let e=Fr(e=>e.products),t=Fr(e=>e.isLoading),n=Fr(e=>e.hasLoaded),r=Fr(e=>e.error),i=Fr(e=>e.fetchProducts);return(0,y.useEffect)(()=>{!n&&!t&&i()},[i,n,t]),t&&!n?(0,F.jsxs)(`main`,{className:`\r
          flex min-h-[60vh]\r
            ...
            `,children:[(0,F.jsx)(`span`,{children:`Contactanos`}),(0,F.jsx)(`i`,{className:`fa-solid fa-arrow-right text-xs`,"aria-hidden":`true`})]})]})}),(0,F.jsxs)(`div`,{className:`mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] lg:gap-12 lg:px-8`,children:[(0,F.jsxs)(`div`,{children:[(0,F.jsxs)(P,{to:`/`,className:`inline-flex items-center gap-2 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40`,"aria-label":`Ecommerce - Inicio`,children:[(0,F.jsx)(`span`,{className:`\r
              ...
              `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-bag-shopping text-sm`})}),(0,F.jsx)(`span`,{className:`text-2xl font-extrabold tracking-tight`,children:`Ecommerce`})]}),(0,F.jsx)(`p`,{className:`mt-5 max-w-sm text-sm leading-6 text-white/45`,children:`Tecnología, accesorios y productos seleccionados para acompañar tu día con calidad, diseño y una experiencia de compra simple.`}),(0,F.jsx)(`nav`,{className:`mt-6`,"aria-label":`Redes sociales`,children:(0,F.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,F.jsx)(`a`,{href:`#`,"aria-label":`Instagram`,className:`\r
                ...
                `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-phone text-xs`})}),(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-[10px] uppercase tracking-wider text-white/30`,children:`Teléfono`}),(0,F.jsx)(`span`,{className:`mt-1 block text-sm text-white/55 transition-colors group-hover:text-white`,children:`+1 1123 456 780`})]})]}),(0,F.jsxs)(`div`,{className:`flex items-start gap-3`,children:[(0,F.jsx)(`span`,{className:`\r
                  ...
                  bg-primary/10\r
                  text-primary\r
                `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-location-dot text-xs`})}),(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-[10px] uppercase tracking-wider text-white/30`,children:`Dirección`}),(0,F.jsxs)(`span`,{className:`mt-1 block text-sm leading-5 text-white/55`,children:[`70 Washington Square South,`,(0,F.jsx)(`br`,{}),`New York, NY 10012`]})]})]})]})]})]}),(0,F.jsx)(`div`,{className:`border-t border-white/10`,children:(0,F.jsxs)(`div`,{className:`mx-auto flex max-w-7xl flex-col gap-3 px-4 py-5 text-xs text-white/35 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8`,children:[(0,F.jsxs)(`p`,{children:[`© `,e,` Ecommerce. Todos los derechos reservados.`]}),(0,F.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,F.jsxs)(`span`,{className:`flex items-center gap-1.5`,children:[(0,F.jsx)(`i`,{className:`fa-solid fa-shield-halved text-[10px] text-primary/70`,"aria-hidden":`true`}),`Compra segura`]}),(0,F.jsx)(`span`,{className:`hidden h-3 w-px bg-white/10 sm:block`,"aria-hidden":`true`}),(0,F.jsxs)(`span`,{className:`flex items-center gap-1.5`,children:[(0,F.jsx)(`i`,{className:`fa-solid fa-lock text-[10px] text-primary/70`,"aria-hidden":`true`}),`Pago protegido`]})]})]})})]})},Hr=({title:e,ariaLabel:t,links:n})=>(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`h2`,{className:`text-sm font-bold text-white`,children:e}),(0,F.jsx)(`nav`,{className:`mt-5`,"aria-label":t,children:(0,F.jsx)(`ul`,{className:`space-y-3`,children:n.map(e=>(0,F.jsx)(`li`,{children:(0,F.jsxs)(P,{to:e.href,className:`\r
                ...
                `,children:[(0,F.jsx)(`i`,{className:`\r
                    ...
                    transition-transform duration-200\r
                    group-hover:translate-x-1\r
                  `,"aria-hidden":`true`}),e.label]})},e.href))})})]}),Ur={firstName:``,lastName:``,email:``,phone:``,address:``,city:``,province:``,postalCode:``},Wr=1e5,Gr=5e3,Kr=e=>e.toLocaleString(`es-AR`,{minimumFractionDigits:0,maximumFractionDigits:0}),qr=e=>e>=Wr?0:Gr,Jr=()=>{let e=Ge(),t=I(e=>e.cartItem),n=I(e=>e.getTotalItems),r=I(e=>e.clearCart),[i,a]=(0,y.useState)(Ur),[o,s]=(0,y.useState)(`card`),[c,l]=(0,y.useState)(!1),[u,d]=(0,y.useState)(``),f=n(),p=t.reduce((e,t)=>e+t.price*t.qty,0),m=qr(p),h=p+m,g=(e,t)=>{a(n=>({...n,[e]:t}))};return t.length===0?(0,F.jsx)(`main`,{className:`\r
          min-h-[70vh]\r
          bg-background\r
          px-4 py-12\r
          sm:px-6 lg:px-8\r
          ...
          `,children:[(0,F.jsx)(`div`,{className:`\r
            ...
            `,children:[`Explorar productos`,(0,F.jsx)(`i`,{className:`fa-solid fa-arrow-right text-xs`,"aria-hidden":`true`})]})]})}):(0,F.jsx)(`main`,{className:`min-h-screen bg-background py-10 sm:py-12 lg:py-16`,children:(0,F.jsxs)(`div`,{className:`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8`,children:[(0,F.jsxs)(`header`,{className:`mb-8`,children:[(0,F.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-[0.18em] text-primary`,children:`Finalizar compra`}),(0,F.jsx)(`h1`,{className:`mt-1 text-2xl font-extrabold tracking-tight text-secondary sm:text-3xl`,children:`Checkout`}),(0,F.jsx)(`p`,{className:`mt-1 text-sm text-gray-500`,children:`Completá tus datos para confirmar tu pedido.`})]}),(0,F.jsxs)(`form`,{onSubmit:async n=>{if(n.preventDefault(),t.length===0){d(`Tu carrito está vacío. Agregá productos antes de continuar.`);return}d(``),l(!0);try{await new Promise(e=>{window.setTimeout(e,1800)});let t={orderNumber:`EC-${Math.random().toString(36).slice(2,8).toUpperCase()}`,total:h,totalItems:f,paymentMethod:o,customer:i,createdAt:new Date().toISOString()};r(),e(`/order-success`,{replace:!0,state:t})}catch{d(`No pudimos procesar la compra. Intentá nuevamente.`)}finally{l(!1)}},className:`grid gap-6 lg:grid-cols-[1fr_380px]`,children:[(0,F.jsxs)(`div`,{className:`space-y-6`,children:[(0,F.jsxs)(`section`,{"aria-labelledby":`customer-data-title`,className:`\r
              ...
              `,children:[(0,F.jsxs)(`div`,{className:`mb-5 flex items-center gap-3`,children:[(0,F.jsx)(`span`,{className:`\r
                    ...
                    bg-primary/10\r
                    text-primary\r
                  `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-user text-sm`})}),(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`h2`,{id:`customer-data-title`,className:`text-base font-bold text-secondary`,children:`Datos personales`}),(0,F.jsx)(`p`,{className:`text-xs text-gray-400`,children:`Información de contacto`})]})]}),(0,F.jsxs)(`div`,{className:`grid gap-4 sm:grid-cols-2`,children:[(0,F.jsx)(Yr,{label:`Nombre`,name:`firstName`,value:i.firstName,onChange:e=>g(`firstName`,e),placeholder:`Martín`,required:!0}),(0,F.jsx)(Yr,{label:`Apellido`,name:`lastName`,value:i.lastName,onChange:e=>g(`lastName`,e),placeholder:`Morondo`,required:!0}),(0,F.jsx)(Yr,{label:`Email`,name:`email`,type:`email`,value:i.email,onChange:e=>g(`email`,e),placeholder:`tu@email.com`,required:!0}),(0,F.jsx)(Yr,{label:`Teléfono`,name:`phone`,type:`tel`,value:i.phone,onChange:e=>g(`phone`,e),placeholder:`+54 9 11 1234 5678`,required:!0})]})]}),(0,F.jsxs)(`section`,{"aria-labelledby":`shipping-title`,className:`\r
                rounded-2xl\r
                border border-black/[0.06]\r
                bg-white\r
                p-5\r
              ...
              `,children:[(0,F.jsxs)(`div`,{className:`mb-5 flex items-center gap-3`,children:[(0,F.jsx)(`span`,{className:`\r
                    ...
                    bg-primary/10\r
                    text-primary\r
                  `,"aria-hidden":`true`,children:(0,F.jsx)(`i`,{className:`fa-solid fa-location-dot text-sm`})}),(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`h2`,{id:`shipping-title`,className:`text-base font-bold text-secondary`,children:`Dirección de envío`}),(0,F.jsx)(`p`,{className:`text-xs text-gray-400`,children:`¿Dónde entregamos tu pedido?`})]})]}),(0,F.jsxs)(`div`,{className:`grid gap-4 sm:grid-cols-2`,children:[(0,F.jsx)(`div`,{className:`sm:col-span-2`,children:(0,F.jsx)(Yr,{label:`Dirección`,name:`address`,value:i.address,onChange:e=>g(`address`,e),placeholder:`Av. Corrientes 1234`,required:!0})}),(0,F.jsx)(Yr,{label:`Ciudad`,name:`city`,value:i.city,onChange:e=>g(`city`,e),placeholder:`Buenos Aires`,required:!0}),(0,F.jsx)(Yr,{label:`Provincia`,name:`province`,value:i.province,onChange:e=>g(`province`,e),placeholder:`Buenos Aires`,required:!0}),(0,F.jsx)(Yr,{label:`Código postal`,name:`postalCode`,value:i.postalCode,onChange:e=>g(`postalCode`,e),placeholder:`1000`,required:!0})]})]}),(0,F.jsxs)(`section`,{"aria-labelledby":`payment-title`,className:`\r
                rounded-2xl\r
                border border-black/[0.06]\r
                bg-white\r
                p-5\r
              ...
              `,children:[(0,F.jsxs)(`div`,{className:`mb-5 flex items-center gap-3`,children:[(0,F.jsx)(`span`,{className:`\r
                ...
                `,children:t.map(e=>(0,F.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,F.jsxs)(`div`,{className:`relative flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-background p-2`,children:[(0,F.jsx)(`img`,{src:e.cover,alt:`Imagen de ${e.name}`,className:`h-full w-full object-contain`}),(0,F.jsx)(`span`,{className:`\r
                        ...
                        `,"aria-label":`Cantidad: ${e.qty}`,children:e.qty})]}),(0,F.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,F.jsx)(`p`,{className:`\r
                          ...
                          text-sm font-semibold\r
                          text-secondary\r
                        `,title:e.name,children:e.name}),(0,F.jsxs)(`p`,{className:`mt-0.5 text-xs text-gray-400`,children:[`$`,Kr(e.price),` c/u`]})]}),(0,F.jsxs)(`span`,{className:`text-sm font-bold text-secondary`,children:[`$`,Kr(e.price*e.qty)]})]},e.id))}),(0,F.jsx)(`div`,{className:`my-5 h-px bg-black/[0.06]`,"aria-hidden":`true`}),(0,F.jsxs)(`div`,{className:`space-y-3`,children:[(0,F.jsxs)(`div`,{className:`flex items-center justify-between text-sm`,children:[(0,F.jsx)(`span`,{className:`text-gray-500`,children:`Subtotal`}),(0,F.jsxs)(`span`,{className:`font-medium text-secondary`,children:[`$`,Kr(p)]})]}),(0,F.jsxs)(`div`,{className:`flex items-center justify-between text-sm`,children:[(0,F.jsx)(`span`,{className:`text-gray-500`,children:`Envío`}),m===0?(0,F.jsx)(`span`,{className:`font-semibold text-green-600`,children:`Gratis`}):(0,F.jsxs)(`span`,{className:`font-medium text-secondary`,children:[`$`,Kr(m)]})]})]}),(0,F.jsx)(`div`,{className:`my-5 h-px bg-black/[0.06]`,"aria-hidden":`true`}),(0,F.jsx)(`div`,{className:`flex items-end justify-between gap-4`,children:(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-xs text-gray-400`,children:`Total`}),(0,F.jsxs)(`strong`,{className:`mt-1 block text-2xl font-extrabold text-secondary`,children:[`$`,Kr(h)]})]})}),(0,F.jsx)(`button`,{type:`submit`,disabled:c,className:`\r
                  mt-6\r
                  flex w-full\r
                  items-center justify-center gap-2\r
                  rounded-xl\r
                ...
                `,children:c?(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(`span`,{className:`\r
                  ...
                  text-[10px]\r
                  text-gray-400\r
                `,children:[(0,F.jsx)(`i`,{className:`fa-solid fa-lock text-primary`,"aria-hidden":`true`}),`Simulación de compra segura`]})]})})]})]})})},Yr=({label:e,name:t,value:n,onChange:r,placeholder:i,type:a=`text`,required:o=!1})=>(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`label`,{htmlFor:t,className:`\r
          mb-1.5 block\r
          text-xs font-semibold\r
          text-secondary\r
        ...
        `})]}),Xr=({value:e,selected:t,onChange:n,icon:r,title:i,description:a})=>{let o=t===e;return(0,F.jsxs)(`label`,{className:`
      ...
      `,children:[(0,F.jsx)(`input`,{type:`radio`,name:`paymentMethod`,value:e,checked:o,onChange:()=>n(e),className:`sr-only`}),(0,F.jsx)(`span`,{className:`
          ...
          `,children:[(0,F.jsxs)(`div`,{className:`\r
            ...
            `,children:[(0,F.jsx)(`div`,{className:`\r
              ...
              `,children:`Tu pedido fue procesado correctamente. Esta es una simulación del proceso de compra.`})]}),(0,F.jsxs)(`div`,{className:`p-6 sm:p-8`,children:[(0,F.jsxs)(`div`,{className:`\r
                ...
                sm:items-center\r
                sm:justify-between\r
              `,children:[(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-[10px] font-bold uppercase tracking-wider text-primary`,children:`Número de pedido`}),(0,F.jsxs)(`strong`,{className:`mt-1 block text-lg font-extrabold tracking-wide text-secondary`,children:[`#`,t.orderNumber]})]}),(0,F.jsxs)(`div`,{className:`text-left sm:text-right`,children:[(0,F.jsx)(`span`,{className:`block text-[10px] font-bold uppercase tracking-wider text-gray-400`,children:`Fecha`}),(0,F.jsx)(`span`,{className:`mt-1 block text-sm font-medium capitalize text-secondary`,children:n})]})]}),(0,F.jsxs)(`div`,{className:`mt-6`,children:[(0,F.jsx)(`h2`,{className:`text-base font-bold text-secondary`,children:`Resumen de tu compra`}),(0,F.jsxs)(`div`,{className:`mt-4 space-y-3`,children:[(0,F.jsxs)(`div`,{className:`flex items-center justify-between text-sm`,children:[(0,F.jsx)(`span`,{className:`text-gray-500`,children:`Productos`}),(0,F.jsx)(`span`,{className:`font-medium text-secondary`,children:t.totalItems})]}),(0,F.jsxs)(`div`,{className:`flex items-center justify-between text-sm`,children:[(0,F.jsx)(`span`,{className:`text-gray-500`,children:`Método de pago`}),(0,F.jsx)(`span`,{className:`max-w-[55%] text-right font-medium text-secondary`,children:Zr[t.paymentMethod]})]}),(0,F.jsxs)(`div`,{className:`flex items-center justify-between text-sm`,children:[(0,F.jsx)(`span`,{className:`text-gray-500`,children:`Cliente`}),(0,F.jsxs)(`span`,{className:`font-medium text-secondary`,children:[t.customer.firstName,` `,t.customer.lastName]})]})]})]}),(0,F.jsx)(`div`,{className:`my-6 h-px bg-black/[0.06]`,"aria-hidden":`true`}),(0,F.jsxs)(`div`,{className:`\r
                flex items-end justify-between\r
                rounded-2xl\r
                bg-background\r
                p-4\r
              `,children:[(0,F.jsxs)(`div`,{children:[(0,F.jsx)(`span`,{className:`block text-xs text-gray-400`,children:`Total pagado`}),(0,F.jsxs)(`strong`,{className:`mt-1 block text-2xl font-extrabold text-secondary`,children:[`$`,$r(t.total)]})]}),(0,F.jsxs)(`span`,{className:`\r
                  flex items-center gap-1.5\r
                  rounded-full\r
                  bg-green-50\r
                  px-3 py-1.5\r
            ...
            leading-5\r
            text-gray-400\r
          `,children:`Este checkout es una simulación. No se realizó ningún cargo real ni se procesaron datos bancarios.`})]})})},ti=()=>{let e=Fr(e=>e.products),t=Fr(e=>e.isLoading),n=Fr(e=>e.error),r=Fr(e=>e.hasLoaded),i=Fr(e=>e.fetchProducts);return(0,y.useEffect)(()=>{!r&&!t&&i()},[r,t,i]),t&&!r?(0,F.jsx)(`main`,{className:`\r
          flex min-h-[60vh]\r
          items-center justify-center\r
          bg-background\r
          px-4\r
        ...
        `,role:`alert`,children:(0,F.jsxs)(`div`,{className:`text-center`,children:[(0,F.jsx)(`i`,{className:`fa-solid fa-triangle-exclamation text-4xl text-red-500`,"aria-hidden":`true`}),(0,F.jsx)(`h1`,{className:`mt-4 text-xl font-bold text-secondary`,children:`No pudimos cargar la tienda`}),(0,F.jsx)(`p`,{className:`mt-2 text-sm text-gray-500`,children:n}),(0,F.jsx)(`button`,{type:`button`,onClick:()=>void i(),className:`\r
              ...
              focus-visible:ring-primary/40\r
              focus-visible:ring-offset-2\r
            `,children:`Reintentar`})]})}):(0,F.jsx)(xr,{shopItems:e.shopItems})};b.createRoot(document.getElementById(`root`)).render((0,F.jsx)(y.StrictMode,{children:(0,F.jsx)(()=>(0,F.jsxs)(Dt,{children:[(0,F.jsx)(qt,{}),(0,F.jsxs)(gt,{children:[(0,F.jsx)(mt,{path:`/`,element:(0,F.jsx)(Lr,{})}),(0,F.jsx)(mt,{path:`/shop`,element:(0,F.jsx)(ti,{})}),(0,F.jsx)(mt,{path:`/cart`,element:(0,F.jsx)(Rr,{})}),(0,F.jsx)(mt,{path:`/checkout`,element:(0,F.jsx)(Jr,{})}),(0,F.jsx)(mt,{path:`/order-success`,element:(0,F.jsx)(ei,{})}),(0,F.jsx)(mt,{path:`*`,element:(0,F.jsx)(pt,{to:`/`,replace:!0})})]}),(0,F.jsx)(Vr,{})]}),{})}));